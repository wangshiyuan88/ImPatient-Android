...
public abstract class ParseLoginDispatchActivity extends Activity {
  ...
  private void runDispatch() {
    if (ParseUser.getCurrentUser() != null) {
      ...
      startNextActivity(new Intent(this, getTargetClass()), TARGET_REQUEST);
    } else {
  ...
  protected void startNextActivity(Intent intent, int targetRequest) {
    startActivityForResult(intent, targetRequest);
  }
